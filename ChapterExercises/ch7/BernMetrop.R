...
trajLength = 150000 # arbitrary large number
...
openGraph(height = 7, width = 3.5) # open new graph window
layout(matrix(1:2, nrow = 2)) # first output goes on top and the second bottom
